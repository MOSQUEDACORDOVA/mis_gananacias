...
$(document).ready(function() {
    ...
    /* --------------------------
     * Edit Row Quantity Method ///////////////////////////////////////////////mosqueda
    --------------------------- */
    var old_row_qty;
    $(document)
    ...
    if (localStorage.getItem('positems')) {
        ...
        $.each(sortedItems, function() {
            ...
            var product_id = item.row.id,
                product_i = item.row.i,
                product_f = item.row.f,
                product_n = item.row.n,
                product_i1 = item.row.i1,
                product_f1 = item.row.f1,
                product_n1 = item.row.n1,
                product_i2 = item.row.i2,
                product_f2 = item.row.f2,
                product_n2 = item.row.n2,
                product_i3 = item.row.i3,
                product_f3 = item.row.f3,
                product_n3 = item.row.n3,
                product_i4 = item.row.i4,
                product_f4 = item.row.f4,
                product_n4 = item.row.n4,
...
// cambios mosqueda
            tr_html =
                ...
                product_id +
                '"><input name="i" id="i" type="hidden" class="rid" value="' +
                product_i +
                '"><input name="f" id="f" type="hidden" class="rid" value="' +
                product_f +
                '"><input name="n" id="n" type="hidden" class="rid" value="' +
                product_n +
                '"><input name="i1" id="i1" type="hidden" class="rid" value="' +
                product_i1 +
                '"><input name="f1" id="f1" type="hidden" class="rid" value="' +
                product_f1 +
                '"><input name="n1" id="n1" type="hidden" class="rid" value="' +
                product_n1 +
                '"><input name="i2" id="i2" type="hidden" class="rid" value="' +
                product_i2 +
                '"><input name="f2" id="f2" type="hidden" class="rid" value="' +
                product_f2 +
                '"><input name="n2" id="n2" type="hidden" class="rid" value="' +
                product_n2 +
                '"><input name="i3" id="i3" type="hidden" class="rid" value="' +
                product_i3 +
                '"><input name="f3" id="f3" type="hidden" class="rid" value="' +
                product_f3 +
                '"><input name="n3" id="n3" type="hidden" class="rid" value="' +
                product_n3 +
                '"><input name="i4" id="i4" type="hidden" class="rid" value="' +
                product_i4 +
                '"><input name="f4" id="f4" type="hidden" class="rid" value="' +
                product_f4 +
                '"><input name="n4" id="n4" type="hidden" class="rid" value="' +
                product_n4 +
            ...
            tr_html +=
                ...
                '" value="' +
                //item_price +
                RangosPrice2O(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatDecimal, formatMoney, parseFloat, pr_tax_val, unit_price) +
                '"><input class="ruprice" name="unit_price[]" type="hidden" value="' +
                //unit_price +
                //Josuue_Unit
                RangosPriceO(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatDecimal, formatMoney, parseFloat, pr_tax_val, unit_price) +
                //product_n +
                ...
                //test item_price
                //Josuue
                formatMoney(parseFloat(RangosPrice2O(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatDecimal, formatMoney, parseFloat, pr_tax_val, unit_price)) + parseFloat(pr_tax_val)) +
                '</span></td>';
                // cambios mosqueda
            tr_html +=
            ...
            tr_html +=
                ...
                '">' +
                //Josuue
                RangosSubT(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatMoney, parseFloat, pr_tax_val) +
            ...
            //Josuue
            //total +=  RangosTotal(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatDecimal, formatMoney, parseFloat, pr_tax_val);   
            total += formatDecimal((parseFloat(RangosTotal(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatDecimal, formatMoney, parseFloat, pr_tax_val)) + parseFloat(pr_tax_val)) * parseFloat(item_qty), 4);
                ...
                b_items +=
                    printLine(
                        '   ' +
                            ...
                            //test item_price
                            //Josuue
                            //RangosItemPrice(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatMoney, parseFloat, pr_tax_val) +
...
function RangosSubT(product_i, product_f, product_n, item_qty, item_price,formatMoney,parseFloat,pr_tax_val){
            ...
            if ((item_qty >= product_i) && (item_qty <= product_f)) {

            rango.push(formatDecimal((parseFloat(product_n) + parseFloat(pr_tax_val)) * parseFloat(item_qty), 4))
...
function RangosSubT(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatMoney, parseFloat, pr_tax_val){

    const rango = [];

    for (let elemento = product_f; elemento <= item_qty; elemento++) {
        //rango.push(elemento);
    }

let age ;

item_qty < product_i ? rango.push(formatMoney((parseFloat(item_price) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty < product_i ? rango.push(formatMoney((parseFloat(product_n) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty <= product_f ? rango.push(formatMoney((parseFloat(product_n) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty < product_i1 ? rango.push(formatMoney((parseFloat(product_n1) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty <= product_f1 ? rango.push(formatMoney((parseFloat(product_n1) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty < product_i2 ? rango.push(formatMoney((parseFloat(product_n2) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty <= product_f2 ? rango.push(formatMoney((parseFloat(product_n2) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty < product_i3 ? rango.push(formatMoney((parseFloat(product_n3) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty <= product_f3 ? rango.push(formatMoney((parseFloat(product_n3) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty < product_i4 ? rango.push(formatMoney((parseFloat(product_n4) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) :
item_qty <= product_f4 ? rango.push(formatMoney((parseFloat(product_n4) + parseFloat(pr_tax_val)) * parseFloat(item_qty))) : rango.push(formatMoney((parseFloat(item_price) + parseFloat(pr_tax_val)) * parseFloat(item_qty)));
...
function RangosTotal(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatDecimal, formatMoney, parseFloat, pr_tax_val){
...
item_qty < product_i ? rango.push(formatDecimal((parseFloat(item_price)))) :
item_qty < product_i ? rango.push(formatDecimal((parseFloat(product_n)))) :
item_qty <= product_f ? rango.push(formatDecimal((parseFloat(product_n)))) :
item_qty < product_i1 ? rango.push(formatDecimal((parseFloat(product_n1)))) :
item_qty <= product_f1 ? rango.push(formatDecimal((parseFloat(product_n1)))) :
item_qty < product_i2 ? rango.push(formatDecimal((parseFloat(product_n2)))) :
item_qty <= product_f2 ? rango.push(formatDecimal((parseFloat(product_n2)))) :
item_qty < product_i3 ? rango.push(formatDecimal((parseFloat(product_n3)))) :
item_qty <= product_f3 ? rango.push(formatDecimal((parseFloat(product_n3)))) :
item_qty < product_i4 ? rango.push(formatDecimal((parseFloat(product_n4)))) :
item_qty <= product_f4 ? rango.push(formatDecimal((parseFloat(product_n4)))) : rango.push(formatDecimal((parseFloat(item_price))));
...
function RangosPriceO(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatDecimal, formatMoney, parseFloat, pr_tax_val, unit_price){
...
item_qty < product_i ? rango.push(unit_price) :
item_qty < product_i ? rango.push(product_n) :
item_qty <= product_f ? rango.push(product_n) :
item_qty < product_i1 ? rango.push(product_n1) :
item_qty <= product_f1 ? rango.push(product_n1) :
item_qty < product_i2 ? rango.push(product_n2) :
item_qty <= product_f2 ? rango.push(product_n2) :
item_qty < product_i3 ? rango.push(product_n3) :
item_qty <= product_f3 ? rango.push(product_n3) :
item_qty < product_i4 ? rango.push(product_n4) :
item_qty <= product_f4 ? rango.push(product_n4) : rango.push(unit_price);
...
function RangosPrice2O(product_i, product_f, product_n, product_i1, product_f1, product_n1, product_i2, product_f2, product_n2, product_i3, product_f3, product_n3, product_i4, product_f4, product_n4, item_price, item_qty, formatDecimal, formatMoney, parseFloat, pr_tax_val, unit_price){
...
item_qty < product_i ? rango.push(item_price) :
item_qty < product_i ? rango.push(product_n) :
item_qty <= product_f ? rango.push(product_n) :
item_qty < product_i1 ? rango.push(product_n1) :
item_qty <= product_f1 ? rango.push(product_n1) :
...
item_qty <= product_f3 ? rango.push(product_n3) :
item_qty < product_i4 ? rango.push(product_n4) :
item_qty <= product_f4 ? rango.push(product_n4) : rango.push(item_price);
