          ...
          <!-- Cambios mosqueda -->  
                    ...
                    <div class="form-group standard">
                        ...
                        <div class="row" id="supplier-con">                           
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('i', ($_POST['i'] ?? ($product ? $product->i : '')), 'class="form-control id="i" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('f', ($_POST['f'] ?? ($product ? $product->f : '')), 'class="form-control id="f" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('n', (isset($_POST['n']) ? $_POST['n'] : ($product ? $this->sma->formatDecimal($product->n) : '')), 'class="form-control tip" id="n" required="required"') ?>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="supplier-con">                           
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('i1', ($_POST['i1'] ?? ($product ? $product->i1 : '')), 'class="form-control id="i1" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('f1', ($_POST['f1'] ?? ($product ? $product->f1 : '')), 'class="form-control id="f1" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('n1', (isset($_POST['n1']) ? $_POST['n1'] : ($product ? $this->sma->formatDecimal($product->n1) : '')), 'class="form-control tip" id="n1" required="required"') ?>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="supplier-con">                           
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('i2', ($_POST['i2'] ?? ($product ? $product->i2 : '')), 'class="form-control id="i2" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('f2', ($_POST['f2'] ?? ($product ? $product->f2 : '')), 'class="form-control id="f2" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('n2', (isset($_POST['n2']) ? $_POST['n2'] : ($product ? $this->sma->formatDecimal($product->n2) : '')), 'class="form-control tip" id="n2" required="required"') ?>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="supplier-con">                           
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('i3', ($_POST['i3'] ?? ($product ? $product->i3 : '')), 'class="form-control id="i3" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('f3', ($_POST['f3'] ?? ($product ? $product->f3 : '')), 'class="form-control id="f3" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('n3', (isset($_POST['n3']) ? $_POST['n3'] : ($product ? $this->sma->formatDecimal($product->n3) : '')), 'class="form-control tip" id="n3" required="required"') ?>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="supplier-con">                           
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('i4', ($_POST['i4'] ?? ($product ? $product->i4 : '')), 'class="form-control id="i4" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('f4', ($_POST['f4'] ?? ($product ? $product->f4 : '')), 'class="form-control id="f4" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                <?= form_input('n4', (isset($_POST['n4']) ? $_POST['n4'] : ($product ? $this->sma->formatDecimal($product->n4) : '')), 'class="form-control tip" id="n4" required="required"') ?>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#addrank').click(function () {
            if (su <= 5) {
                $('#rango_price_1').select2('destroy');
                var html = '<div style="clear:both;height:5px;"></div><div class="col-xs-6"><div class="form-group"><input type="text" name="amount_i' + su + '" class="form-control tip" id="amount_i' + su + '" placeholder="<?= lang('amount_i') ?>" /></div></div><div class="col-xs-6"><div class="form-group"><input type="text" name="amount_f' + su + '" class="form-control tip" id="amount_f' + su + '" placeholder="<?= lang('amount_f') ?>" /></div></div></div><div class="col-xs-6"><div class="form-group"><input type="text" name="amount_price' + su + '" class="form-control tip" id="amount_price' + su + '" placeholder="<?= lang('amount_price') ?>" /></div></div></div';
                $('#ex-ranks').append(html);
                var sup = $('#rango_price_' + su);
                suppliers(sup);
                su++;
            } else {
                bootbox.alert('<?= lang('max_reached') ?>');
