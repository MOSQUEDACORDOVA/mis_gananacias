        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group standard">
                    ...
                    <div class="form-group">
                        <?= lang('rango_price', 'rango_price') ?>
                        <button type="button" class="btn btn-primary btn-xs" id="addrank"><i class="fa fa-plus"></i>
                        </button>
                    </div>
                    <div class="col-6 col-md-4 themed-grid-col" id="rank-con">
                        <div class="col-3">
                            <div class="form-group">
                                <?= form_input('amount_i', ($_POST['amount_i'] ?? ''), 'class="form-control tip" id="amount_i" placeholder="' . lang('amount_i') . '"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 themed-grid-col" id="rank-con">
                        <div class="col-3">
                            <div class="form-group">
                                <?= form_input('amount_f', ($_POST['amount_f'] ?? ''), 'class="form-control tip" id="amount_f" placeholder="' . lang('amount_f') . '"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-4 themed-grid-col" id="rank-con">
                        <div class="col-3">
                            <div class="form-group">
                                <?= form_input('amount_price', ($_POST['amount_price'] ?? ''), 'class="form-control tip" id="amount_price" placeholder="' . lang('amount_price') . '"'); ?>
                            </div>
                        </div>
                    </div>
                    <div id="ex-ranks"></div>
    ...
    $(document).ready(function () {
        ...
        $('#addrank').click(function () {
            if (su <= 5) {
                ...
                var html = '<div style="clear:both;height:5px;"></div><div class="col-md-12"><div class="form-group standard"><div class="row mb-3"><div class="col-6 col-md-4 themed-grid-col"><input type="text" name="amount_i' + su + '" class="form-control tip" id="amount_i' + su + '" placeholder="<?= lang('amount_i') ?>" /></div><div class="col-6 col-md-4 themed-grid-col"><input type="text" name="amount_f' + su + '" class="form-control tip" id="amount_f' + su + '" placeholder="<?= lang('amount_f') ?>" /></div><div class="col-6 col-md-4 themed-grid-col"><input type="text" name="amount_price' + su + '" class="form-control tip" id="amount_price' + su + '" placeholder="<?= lang('amount_price') ?>" /></div></div></div></div>';
