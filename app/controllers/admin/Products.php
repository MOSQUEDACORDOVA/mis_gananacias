...
class Products extends MY_Controller
{
    ...
    public function add($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data     = [
                ...
                'i'                 => $this->input->post('amount_i') == '' ? '0' : $this->input->post('amount_i'),
                'f'                 => $this->input->post('amount_f') == '' ? '0' : $this->input->post('amount_f'),
                'n'                 => $this->input->post('amount_price') == '' ? '0' : $this->input->post('amount_price'),
                'i1'                 => $this->input->post('amount_i2') == '' ? '0' : $this->input->post('amount_i2'),
                'f1'                 => $this->input->post('amount_f2') == '' ? '0' : $this->input->post('amount_f2'),
                'n1'                 => $this->input->post('amount_price2') == '' ? '0' : $this->input->post('amount_price2'),
                'i2'                 => $this->input->post('amount_i3') == '' ? '0' : $this->input->post('amount_i3'),
                'f2'                 => $this->input->post('amount_f3') == '' ? '0' : $this->input->post('amount_f3'),
                'n2'                 => $this->input->post('amount_price3') == '' ? '0' : $this->input->post('amount_price3'),
                'i3'                 => $this->input->post('amount_i4') == '' ? '0' : $this->input->post('amount_i4'),
                'f3'                 => $this->input->post('amount_f4') == '' ? '0' : $this->input->post('amount_f4'),
                'n3'                 => $this->input->post('amount_price4') == '' ? '0' : $this->input->post('amount_price4'),
                'i4'                 => $this->input->post('amount_i5') == '' ? '0' : $this->input->post('amount_i5'),
                'f4'                 => $this->input->post('amount_f5') == '' ? '0' : $this->input->post('amount_f5'),
                'n4'                 => $this->input->post('amount_price5') == '' ? '0' : $this->input->post('amount_price5'),
            ];
            $warehouse_qty      = null;
    ...
    public function view($id = null)
    {
        ...
        $pr_details = $this->products_model->getProductByID($id);
        $pr_rango = $this->products_model->getProductByID($id);
        if (!$id || !$pr_details) {
            $this->session->set_flashdata('error', lang('prduct_not_found'));
            redirect($_SERVER['HTTP_REFERER']);
        }
